  ...
  return (
    <>
      ...
      <Section className="relative overflow-hidden pt-24 sm:pt-28 md:pt-32">
        ...
        <div className="relative z-10 text-center space-y-5 sm:space-y-6 max-w-3xl mx-auto">
          {/* Badge */}
          ...
          {/* Heading */}
          <Heading level={1} align="center" className="!leading-tight gradient-text tracking-wide">
            Get in Touch
          </Heading>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6">
            {contactMethods.map((method, index) => (
              <Link
                ...
                className="group"
              >
                <Card hoverable variant="elevated" className="h-full border-2 border-secondary/10 group-hover:border-secondary/40">
                  <div className="flex flex-col items-center text-center space-y-5">
                    {/* Icon */}
                    <div className={`${method.color} p-4 bg-surface/50 backdrop-blur-sm rounded-2xl group-hover:scale-110 group-hover:shadow-glow transition-all duration-500 border border-secondary/20`}>
                      {method.icon}
                    </div>
                    {/* Content */}
                    <div className="space-y-2">
                      <Heading level={3} align="center" className="text-lg sm:text-xl font-semibold gradient-text">
                        {method.title}
                      </Heading>
                      <Text size="sm" color="secondary" align="center" className="leading-relaxed text-text-secondary">
                        {method.description}
                      </Text>
                    </div>
                  </div>
      ...
      <Section className="relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <Card variant="elevated" className="text-center border-2 border-secondary/20">
            <div className="space-y-6 sm:space-y-7">
              {/* Logo */}
              <div className="flex justify-center">
                <div className="relative w-16 h-16 sm:w-20 sm:h-20 shadow-glow">
                  <Image
                    src={company.logo}
                    alt={company.name}
                    fill
              ...
              <div className="space-y-3">
                <Heading level={2} align="center" className="text-2xl sm:text-3xl gradient-text">
                  Partnership Opportunities
                </Heading>
                <Text size="base" color="secondary" align="center" className="max-w-2xl mx-auto text-text-secondary">
              ...
              <div className="py-4 sm:py-6">
                <div className="grid grid-cols-2 gap-3 sm:gap-4 max-w-2xl mx-auto">
                  {[
                    ...
                    <div key={idx} className="flex items-start space-x-2.5 p-3 glass rounded-lg border border-secondary/20 hover:border-secondary/30 transition-all duration-300">
                      <div className="flex-shrink-0 w-6 h-6 mt-0.5 bg-gradient-to-br from-secondary to-accent text-bg-primary rounded-full flex items-center justify-center text-xs font-bold shadow-glow-sm">
                        ✓
                      </div>
                      <Text size="sm" className="font-medium text-left text-text-primary leading-6">
                        {benefit}
                      </Text>
                    </div>
                  ))}
              ...
              <div className="pt-3 sm:pt-4">
                ...
                >
                  <button className="inline-flex items-center justify-center px-6 py-3 sm:px-8 sm:py-4 bg-gradient-to-r from-secondary to-accent text-bg-primary font-bold rounded-xl hover:shadow-glow-lg transition-all duration-400 min-h-[48px] text-sm sm:text-base hover:-translate-y-1">
      ...
      <Section className="relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <Card variant="elevated" className="text-center glass-strong border border-secondary/20">
            <div className="space-y-5 sm:space-y-6">
              {/* Icon */}
              <div className="flex justify-center">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-secondary/20 backdrop-blur-sm rounded-full flex items-center justify-center border border-secondary/30">
                  <svg className="w-8 h-8 sm:w-10 sm:h-10 text-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="space-y-4">
                ...
                <Text size="lg" color="secondary" align="center" className="max-w-2xl mx-auto leading-relaxed text-text-secondary">
                  We're active across Jakarta's nightlife scene, hosting events at various venues throughout the city.
                </Text>
                <div className="pt-2">
                  <Text size="base" color="muted" align="center" className="italic text-text-tertiary">
